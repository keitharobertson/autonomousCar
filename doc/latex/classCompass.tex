...
Performs the analysis of the data collected from the compass. 
...
Init sensor is an abstract function declared in the \hyperlink{classSensor}{Sensor} class. Its implementation for the \hyperlink{classCompass}{Compass} subsystem includes setting up the I2\-C driver and setting up the compass hardware to continuously spit out data at 20\-Hz. 
