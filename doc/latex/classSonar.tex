...
\item 
\hyperlink{SUBSYS__COMMANDS_8h_ad814416fc1a8c675bea2687d96088a8f}{M\-E\-S\-S\-A\-G\-E} \hyperlink{classSonar_a44a265ac2b363cdd0e944285a7c07eb8}{change\-\_\-speed}
\item 
...
\item 
\hyperlink{SUBSYS__COMMANDS_8h_ad814416fc1a8c675bea2687d96088a8f}{M\-E\-S\-S\-A\-G\-E} \hyperlink{classSonar_adc1ca3536457074b9ba2ca5880154ce6}{set\-\_\-cps\-\_\-prio}
\item 
\hyperlink{SUBSYS__COMMANDS_8h_ad814416fc1a8c675bea2687d96088a8f}{M\-E\-S\-S\-A\-G\-E} \hyperlink{classSonar_a3db9cf5f86aab72001ae088b68c0936f}{change\-\_\-direction}
\item 
\hyperlink{SUBSYS__COMMANDS_8h_ad814416fc1a8c675bea2687d96088a8f}{M\-E\-S\-S\-A\-G\-E} \hyperlink{classSonar_a403e0e1741cb9ff1872dbe74a7c701d6}{en\-\_\-or\-\_\-dis\-\_\-subsys}
\item 
\hyperlink{SUBSYS__COMMANDS_8h_ad814416fc1a8c675bea2687d96088a8f}{M\-E\-S\-S\-A\-G\-E} \hyperlink{classSonar_a9e6e96435c6767549c91d9e67d20161b}{steer\-\_\-straight}
\item 
...
\hypertarget{classSonar_a152453d934da6d4e576f9d59dc80b762}{\index{Sonar@{Sonar}!Sonar@{Sonar}}
...
)}}\label{classSonar_a152453d934da6d4e576f9d59dc80b762}
...
turns 90 degrees left in response to an obstacle \hypertarget{classSonar_a38b0e409082be17e7098b2e471bab4a8}{\index{Sonar@{Sonar}!collector@{collector}}
...
Sets up the S\-P\-I driver (to talk to the \hyperlink{classADC}{A\-D\-C}) and sets up the \hyperlink{classADC}{A\-D\-C} for sonar configuration. 
...
Waits an amount of time and then resets the compass heading to its value prior to obstacle avoidance (value stored in old\-\_\-compass\-\_\-heading). \hypertarget{classSonar_afbda79f1a96e294fb811f03f54a49a46}{\index{Sonar@{Sonar}!reverse\-\_\-direction@{reverse\-\_\-direction}}
\index{reverse\-\_\-direction@{reverse\-\_\-direction}!Sonar@{Sonar}}
\subsubsection[{reverse\-\_\-direction}]{\setlength{\rightskip}{0pt plus 5cm}void Sonar\-::reverse\-\_\-direction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_afbda79f1a96e294fb811f03f54a49a46}
...
\hypertarget{classSonar_a9e2ea95994eefd09ec7546853ebf1cb7}{\index{Sonar@{Sonar}!adc\-\_\-data@{adc\-\_\-data}}
\index{adc\-\_\-data@{adc\-\_\-data}!Sonar@{Sonar}}
\subsubsection[{adc\-\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}{\bf A\-D\-C\-\_\-\-D\-A\-T\-A}$\ast$ Sonar\-::adc\-\_\-data\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a9e2ea95994eefd09ec7546853ebf1cb7}
store the adc data here for cross subsystem access \hypertarget{classSonar_a6e842fc3ef4088c987a7a348df3b75ce}{\index{Sonar@{Sonar}!avoid\-\_\-reset\-\_\-control@{avoid\-\_\-reset\-\_\-control}}
\index{avoid\-\_\-reset\-\_\-control@{avoid\-\_\-reset\-\_\-control}!Sonar@{Sonar}}
...
the obstacle avoidance/reset control semaphore \hypertarget{classSonar_a72b11a8e569125119750ee9dd094141b}{\index{Sonar@{Sonar}!avoidance\-\_\-mode@{avoidance\-\_\-mode}}
...
whether avoidance mode has been entered into \hypertarget{classSonar_a3db9cf5f86aab72001ae088b68c0936f}{\index{Sonar@{Sonar}!change\-\_\-direction@{change\-\_\-direction}}
\index{change\-\_\-direction@{change\-\_\-direction}!Sonar@{Sonar}}
\subsubsection[{change\-\_\-direction}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::change\-\_\-direction\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a3db9cf5f86aab72001ae088b68c0936f}
message used to set the motor direction \hypertarget{classSonar_a44a265ac2b363cdd0e944285a7c07eb8}{\index{Sonar@{Sonar}!change\-\_\-speed@{change\-\_\-speed}}
\index{change\-\_\-speed@{change\-\_\-speed}!Sonar@{Sonar}}
\subsubsection[{change\-\_\-speed}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::change\-\_\-speed\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a44a265ac2b363cdd0e944285a7c07eb8}
message used for changing the motor speed \hypertarget{classSonar_a3dcf7c38af34539c68f123f073eb2f52}{\index{Sonar@{Sonar}!collect\-\_\-analysis\-\_\-sync@{collect\-\_\-analysis\-\_\-sync}}
...
the colector/analysis sync semaphore used to sync the collector and analysis tasks \hypertarget{classSonar_a403e0e1741cb9ff1872dbe74a7c701d6}{\index{Sonar@{Sonar}!en\-\_\-or\-\_\-dis\-\_\-subsys@{en\-\_\-or\-\_\-dis\-\_\-subsys}}
\index{en\-\_\-or\-\_\-dis\-\_\-subsys@{en\-\_\-or\-\_\-dis\-\_\-subsys}!Sonar@{Sonar}}
\subsubsection[{en\-\_\-or\-\_\-dis\-\_\-subsys}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::en\-\_\-or\-\_\-dis\-\_\-subsys\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a403e0e1741cb9ff1872dbe74a7c701d6}
message used to enable or disable a subsystem \hypertarget{classSonar_a27d83a5a5c4859adb65641683e964018}{\index{Sonar@{Sonar}!inter\-\_\-subsys\-\_\-command@{inter\-\_\-subsys\-\_\-command}}
...
Message used for commanding other subsystems (usually compass) \hypertarget{classSonar_ad51a4f80202f692e4630f74490b5ef5d}{\index{Sonar@{Sonar}!last\-\_\-reverse\-\_\-left@{last\-\_\-reverse\-\_\-left}}
\index{last\-\_\-reverse\-\_\-left@{last\-\_\-reverse\-\_\-left}!Sonar@{Sonar}}
...
boolean to tell if the last time we reversed, we went left \hypertarget{classSonar_a29863f7d681d8119c233aa11398f65b7}{\index{Sonar@{Sonar}!msg@{msg}}
\index{msg@{msg}!Sonar@{Sonar}}
...
S\-P\-I request for sonar data from the \hyperlink{classADC}{A\-D\-C} \hypertarget{classSonar_a223e1294a7e00208efcd2a80f57e7620}{\index{Sonar@{Sonar}!old\-\_\-compass\-\_\-heading@{old\-\_\-compass\-\_\-heading}}
...
original compass heading prior to avoidance mode \hypertarget{classSonar_a3ee55a9a946c5c00a68b3774c316728e}{\index{Sonar@{Sonar}!old\-\_\-motor\-\_\-speed@{old\-\_\-motor\-\_\-speed}}
\index{old\-\_\-motor\-\_\-speed@{old\-\_\-motor\-\_\-speed}!Sonar@{Sonar}}
...
original motor speed prior to avoidance mode \hypertarget{classSonar_ac9ab4c77456aea18ac1eb886a5c81f4c}{\index{Sonar@{Sonar}!print\-\_\-data@{print\-\_\-data}}
...
whether to print out data after each collection for debugging/testing \hypertarget{classSonar_a560057581920d76e557880135548ce46}{\index{Sonar@{Sonar}!request\-\_\-compass\-\_\-data@{request\-\_\-compass\-\_\-data}}
\index{request\-\_\-compass\-\_\-data@{request\-\_\-compass\-\_\-data}!Sonar@{Sonar}}
\subsubsection[{request\-\_\-compass\-\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::request\-\_\-compass\-\_\-data\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a560057581920d76e557880135548ce46}
message used for requesting data from compass subsystem \hypertarget{classSonar_a5326194659d6f29efa21b6eae03f6a4e}{\index{Sonar@{Sonar}!request\-\_\-motor\-\_\-data@{request\-\_\-motor\-\_\-data}}
\index{request\-\_\-motor\-\_\-data@{request\-\_\-motor\-\_\-data}!Sonar@{Sonar}}
\subsubsection[{request\-\_\-motor\-\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::request\-\_\-motor\-\_\-data\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a5326194659d6f29efa21b6eae03f6a4e}
message used for requesting data from motor subsystem \hypertarget{classSonar_ad9f288f52d8d26a687a557c714d6f026}{\index{Sonar@{Sonar}!reverse\-\_\-mode@{reverse\-\_\-mode}}
\index{reverse\-\_\-mode@{reverse\-\_\-mode}!Sonar@{Sonar}}
...
whether reverse mode has been entered into \hypertarget{classSonar_a27714390fb769905062ae587d8b2f112}{\index{Sonar@{Sonar}!reverse\-\_\-threshold@{reverse\-\_\-threshold}}
\index{reverse\-\_\-threshold@{reverse\-\_\-threshold}!Sonar@{Sonar}}
...
Threshold distance for sonar avoidance. If the sonar reading drops below this value, the sonar subsystem will take control of the actuators and R\-E\-V\-E\-R\-S\-E to avoid and obstacle \hypertarget{classSonar_adc1ca3536457074b9ba2ca5880154ce6}{\index{Sonar@{Sonar}!set\-\_\-cps\-\_\-prio@{set\-\_\-cps\-\_\-prio}}
\index{set\-\_\-cps\-\_\-prio@{set\-\_\-cps\-\_\-prio}!Sonar@{Sonar}}
\subsubsection[{set\-\_\-cps\-\_\-prio}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::set\-\_\-cps\-\_\-prio\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_adc1ca3536457074b9ba2ca5880154ce6}
message used to set and reset the compass min priority during obstacle avoidance \hypertarget{classSonar_a4799c8b328d7735f7e6d62d741340c6c}{\index{Sonar@{Sonar}!sonar\-\_\-fd@{sonar\-\_\-fd}}
...
The most recent sonar reading \hypertarget{classSonar_a9e6e96435c6767549c91d9e67d20161b}{\index{Sonar@{Sonar}!steer\-\_\-straight@{steer\-\_\-straight}}
\index{steer\-\_\-straight@{steer\-\_\-straight}!Sonar@{Sonar}}
\subsubsection[{steer\-\_\-straight}]{\setlength{\rightskip}{0pt plus 5cm}{\bf M\-E\-S\-S\-A\-G\-E} Sonar\-::steer\-\_\-straight\hspace{0.3cm}{\ttfamily [protected]}}}\label{classSonar_a9e6e96435c6767549c91d9e67d20161b}
message used to center steering \hypertarget{classSonar_af3ec5683614e9f1755e54da32184412a}{\index{Sonar@{Sonar}!treset\-\_\-heading@{treset\-\_\-heading}}
...
reset\-\_\-heading thread \hypertarget{classSonar_a83151cbccbce08be16dfec04a53f3295}{\index{Sonar@{Sonar}!turn\-\_\-threshold@{turn\-\_\-threshold}}
\index{turn\-\_\-threshold@{turn\-\_\-threshold}!Sonar@{Sonar}}
